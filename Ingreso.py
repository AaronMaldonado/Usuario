...
class Ui_Ventana(object):
    ...
    def setupUi(self,Window):
        ...
        self.label8 = QtGui.QLabel(Window)
        self.label8.setGeometry(QtCore.QRect(38, 25, 150, 16))
        self.label8.setObjectName("label")
        self.label9 = QtGui.QLabel(Window)
        self.label9.setGeometry(QtCore.QRect(70, 350, 150, 16))
    ...
    def retranslateUi(self, Window):
        ...
        self.label8.setText(QtGui.QApplication.translate("ProductosWindow", "Seleccione un grupo", None, QtGui.QApplication.UnicodeUTF8))
        self.label9.setText(QtGui.QApplication.translate("ProductosWindow", "* Campos Obligatorios", None, QtGui.QApplication.UnicodeUTF8))
